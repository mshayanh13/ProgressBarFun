...
//  ProgressBarFun
//
//  Created by mshayanh13 on 2/4/17.
//  Copyright © 2017 mshayanh13. All rights reserved.
//
...
public class ProgressBarDraw : NSObject {
    ...
    public dynamic class func drawProgressBar(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 16), progress: CGFloat = 186) {
